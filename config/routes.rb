Rails.application.routes.draw do
  ...
  get '/course/:course_id/sections/:section_id/presentations/new', to: 'presentations#new'
  post '/course/:course_id/sections/:section_id/presentations/new', to: 'presentations#create'
