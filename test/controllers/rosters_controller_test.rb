...
class RostersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create roster" do
    assert_difference('Roster.count') do
      post rosters_url, params: { roster: { section_id: @roster.section_id, status: @roster.status, user_id: @roster.user_id } }
    end
  ...
  test "should update roster" do
    patch roster_url(@roster), params: { roster: { section_id: @roster.section_id, status: @roster.status, user_id: @roster.user_id } }
