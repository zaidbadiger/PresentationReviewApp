...
class PresentationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presentation" do
    assert_difference('Presentation.count') do
      post presentations_url, params: { presentation: { close_date: @presentation.close_date, date: @presentation.date, section_id: @presentation.section_id, title: @presentation.title } }
    end
  ...
  test "should update presentation" do
    patch presentation_url(@presentation), params: { presentation: { close_date: @presentation.close_date, date: @presentation.date, section_id: @presentation.section_id, title: @presentation.title } }
